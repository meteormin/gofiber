...
func (w *containerStruct) App() *fiber.App {
	return w.app
}

// Config
// config.Configs getter
func (w *containerStruct) Config() *config.Configs {
	return w.config
}

// Database
// *gorm.DB getter
func (w *containerStruct) Database() *gorm.DB {
	return w.database
}

// IsProduction
// check app env is production
func (w *containerStruct) IsProduction() bool {
